    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <a href="{{ route('createpackages') }}" class="btn btn-info btn-xs" role="button"><span class="glyphicon glyphicon-plus"></span></a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{$package->package_image}}" class="btn btn-info btn-xs" role="button"><span class="glyphicon glyphicon-eye-open"></span></a><span> </span></td>
                                <td>{{ $package->package_description }}</td>
                                <td>{{ $package->status }}</td>
                                <td>{{ $package->created_at }}</td>
                                <td><a href="/editpackages/{{$package->id}}" class="btn btn-info btn-xs" role="button"><span class="glyphicon glyphicon-edit"></span></a><span> </span><a href="/deletepackage/{{$package->id}}" class="btn btn-info btn-danger btn-xs" role="button"> <span class="glyphicon glyphicon-trash"></span></a></td>
                            </tr>
                             @endforeach
                        </tbody>
                        <tfoot>

        ...
        <div class="col-xs-12">
            ...
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title">Tests Edit</h3>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body">
                    ...
                    <input type="hidden" id="id" name="id" value="{{ Request::segment(2) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="investigation" name="investigation" class="form-control" rows="3" placeholder="Enter Investigations...">{{$services->investigations}}</textarea>
                        </div>
                        <div class="form-group">
                            <label>MRP(INR)</label>
                            <input id="mrp" name="mrp" type="text" class="form-control" placeholder="Enter MRP(INR)..." value="{{$services->mrp}}">
                        </div>

                        <!-- textarea -->
                        <div class="form-group">
                            <label>Sample Type & Volume</label>
                            <input id="sample" name="sample" type="text" class="form-control" placeholder="Sample Type & Volume..." value="{{$services->sample_type_and_volume}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="reporting" name="reporting" type="text" class="form-control" placeholder="Reporting (In Days)..." value="{{$services->reporting}}">
                        </div>

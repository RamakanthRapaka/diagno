    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <a href="/addprofiles" class="btn btn-info btn-xs" role="button"><span class="glyphicon glyphicon-plus"></span></a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $profile->id }}</td>
                                <td>{{ $profile->investigations }}</td>
                                <td>{{ $profile->mrp }}</td>
                                <td>{{ $profile->sample_type_and_volume }}</td>
                                <td>{{ $profile->reporting }}</td>
                                <td><a href="{{ $profile->file }}" class="btn btn-info btn-xs" role="button"><span class="glyphicon glyphicon-eye-open"></span></a><span> </span></td>
                                <td><a href="/editprofiles/{{$profile->id}}" class="btn btn-info btn-xs" role="button"><span class="glyphicon glyphicon-edit"></span></a><span> </span><a href="/deleteprofiles/{{$profile->id}}" class="btn btn-info btn-danger btn-xs" role="button"> <span class="glyphicon glyphicon-trash"></span></a></td>
                            </tr>
                             @endforeach
                        </tbody>
                        <tfoot>

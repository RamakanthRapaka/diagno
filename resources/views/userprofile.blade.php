...
<section class="content">
    ...
    <div class="box box-default">
        ...
        @endif
        <!-- /.box-header -->
        <form enctype="multipart/form-data" role="form" action="{{route('updateuser')}}" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Full Name" id="name" name="name" value="{{$user->name}}">
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
                            <label>Email</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Mobile</label>
                            <input type="text" class="form-control" placeholder="Mobile" id="mobile" name="mobile" value="{{$user->mobile}}">
                        </div>
                        <!-- /.form-group -->
                        <div class="form-group">
                            <label>DOB</label>
                            <input type="text" class="form-control" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask placeholder="DOB" id="dob" name="dob" value="{{$user->dob}}">
                        </div>
                        <!-- /.form-group -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2" data-placeholder="Select Gender" id="gender" name="gender"
                            ...
                            <option value="OTHERS" @if($user->gender == 'OTHERS') selected="selected" @endif>OTHERS</option>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2" data-placeholder="Select Blood Group" id="blood_group" name="blood_group"
                                style="width: 100%;">
                            <option value="O+" @if($user->blood_group == 'O+') selected="selected" @endif>O+</option>
                            <option value="O-" @if($user->blood_group == 'O-') selected="selected" @endif>O-</option>
                            <option value="A+" @if($user->blood_group == 'A+') selected="selected" @endif>A+</option>
                            <option value="A-" @if($user->blood_group == 'A-') selected="selected" @endif>A-</option>
                            <option value="B+" @if($user->blood_group == 'B+') selected="selected" @endif>B+</option>
                            <option value="B-" @if($user->blood_group == 'B-') selected="selected" @endif>B-</option>
                            <option value="AB+" @if($user->blood_group == 'AB+') selected="selected" @endif>AB+</option>
                            <option value="AB-" @if($user->blood_group == 'AB-') selected="selected" @endif>AB-</option>
                        </select>
                        <!-- /.form-group -->
                        <div class="form-group">

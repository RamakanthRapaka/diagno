                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Package ID" id="package_id" name="package_id">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Package Price" id="package_price" name="package_price">
                        </div>
                        
                        <div class="form-group">
                            <label>Package Discount Price</label>
                            <input type="text" class="form-control" placeholder="Package Discount Price" id="discount_price" name="discount_price">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" placeholder="Package Image" id="package_image" name="package_image">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="1" placeholder="Package Description" id="package_description" name="package_description"></textarea>
                        </div>
                    </div>
                </div>

...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Profiles Edit</li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title">Profiles Edit</h3>
                </div>
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form enctype="multipart/form-data" role="form" action="{{route('saveprofiles')}}" method="POST">
                        <input type="hidden" value="{{csrf_token()}}" name="_token" />
                        <input type="hidden" id="id" name="id" value="{{ Request::segment(2) }}"/>
                        <!-- text input -->
                        <div class="form-group">
                            <label>Investigations</label>
                            <textarea id="investigation" name="investigation" class="form-control" rows="3" placeholder="Enter Investigations...">{{$profiles->investigations}}</textarea>
                        </div>
                        <div class="form-group">
                            <label>MRP(INR)</label>
                            <input id="mrp" name="mrp" type="text" class="form-control" placeholder="Enter MRP(INR)..." value="{{$profiles->mrp}}">
                        </div>

                        <!-- textarea -->
                        <div class="form-group">
                            <label>Sample Type & Volume</label>
                            <input id="sample" name="sample" type="text" class="form-control" placeholder="Sample Type & Volume..." value="{{$profiles->sample_type_and_volume}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="reporting" name="reporting" type="text" class="form-control" placeholder="Reporting (In Days)..." value="{{$profiles->reporting}}">
                        </div>
